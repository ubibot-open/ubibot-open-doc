...
> **状态：** 第 0-2 章已经写完。其余章节暂时还是占位内容——正在按章节逐个撰写，具体进度见各章节页面。

## 章节

0. [手册说明](00-overview.zh-CN.md)
1. [开发环境搭建](01-environment-setup.zh-CN.md)
2. [新增一个后台 API 端点](02-backend-add-admin-endpoint.zh-CN.md)
3. [新增数据模型](03-backend-add-model-and-migration.zh-CN.md)
4. [新增后台页面](04-admin-add-page.zh-CN.md)
5. [固件：接入新传感器](05-firmware-add-sensor.zh-CN.md)
